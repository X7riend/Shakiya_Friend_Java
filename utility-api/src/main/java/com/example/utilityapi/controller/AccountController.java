...
public class AccountController {
    ...
    public AccountController() {
        ...
        // counter and new list to hold usernames
        int i = 0;
    ...
    public Account createAccount(@RequestBody @Valid Account account) {
        ...
        // Adding current account usernames to username list
        for(Account userAcc : accountList)
        {
            if (userAcc.getUsername().equals(account.getUsername())) {
